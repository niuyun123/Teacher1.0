...
public class DESCoder {
    ...
    public DESCoder(String firstKey) throws Exception {
        this.firstKey = firstKey;
    }

    public DESCoder() throws Exception {
        this(strDefaultKey);
    }

    private static String strDefaultKey = "hanboard";
    /**
     * DES加密/解密
     * 
            ...
            if (leng < 4) {
                ...
                if (firstKey != null && firstKey != "" ) {
                    ...
                    for (x = 0; x < firstLength; x++) {
                        tempBt = encrypt(tempBt, (int[]) firstKeyBt.get(x));
                    }
                    for (y = 0; y < secondLength; y++) {
                        tempBt = encrypt(tempBt, (int[]) secondKeyBt.get(y));
                    }
                    for (z = 0; z < thirdLength; z++) {
                        tempBt = encrypt(tempBt, (int[]) thirdKeyBt.get(z));
                    }
                    encByte = tempBt;
                } else {
                    if (firstKey != null && firstKey != "" ) {
                    ...
                    if (firstKey != null && firstKey != "" ) {
                        ...
                        if (firstKey != null && firstKey != "") {
                            ...
                            if (firstKey != null && firstKey != "") {
                                ...
                                tempBt = tempByte;
                                for (x = 0; x < firstLength; x++) {
                                    tempBt = encrypt(tempBt, (int[]) firstKeyBt
                                            .get(x));
                                }
                                encByte = tempBt;
                            }
        ...
        for (i = 0; i < iterator; i++) {
            ...
            if (firstKey != null && firstKey != "" ) {
                ...
                for (x = thirdLength - 1; x >= 0; x--) {
                    tempBt = decrypt(tempBt, (int[]) thirdKeyBt.get(x));
                }
                for (y = secondLength - 1; y >= 0; y--) {
                    tempBt = decrypt(tempBt, (int[]) secondKeyBt.get(y));
                }
                for (z = firstLength - 1; z >= 0; z--) {
                    tempBt = decrypt(tempBt, (int[]) firstKeyBt.get(z));
                }
                decByte = tempBt;
            } else {
                if (firstKey != null && firstKey != "" ) {
                    ...
                    for (x = secondLength - 1; x >= 0; x--) {
                        tempBt = decrypt(tempBt, (int[]) secondKeyBt.get(x));
                    }
                    for (y = firstLength - 1; y >= 0; y--) {
                        tempBt = decrypt(tempBt, (int[]) firstKeyBt.get(y));
                    }
                    decByte = tempBt;
                } else {
                    if (firstKey != null && firstKey != "") {
                        ...
                        for (x = firstLength - 1; x >= 0; x--) {
                            tempBt = decrypt(tempBt, (int[]) firstKeyBt.get(x));
                        }
                        decByte = tempBt;
                    }
                }
     ...
     */
    public List getKeyBytes(String key) throws Exception {
     ...
     */
    public int[] strToBt(String str) throws Exception {
        int leng = str.length();
        int[] bt = new int[64];
        if (leng < 4) {
            int i = 0, j = 0, p = 0, q = 0;
     ...
     * return hex
     */
    public String bt4ToHex(String binary) throws Exception {
        String hex = "";
     ...
     */
    public String hexToBt4(String hex) throws Exception {
        String binary = "";
     ...
     * return string
     */
    public String byteToString(int[] byteData) throws Exception {
        String str = "";
        for (int i = 0; i < 4; i++) {
            int count = 0;
            for (int j = 0; j < 16; j++) {
    ...
    public String bt64ToHex(int[] byteData) throws Exception {
        String hex = "";
        for (int i = 0; i < 16; i++) {
            String bt = "";
            for (int j = 0; j < 4; j++) {
    ...
    public String hexToBt64(String hex) throws Exception {
        String binary = "";
        for (int i = 0; i < 16; i++) {
    ...
    public int[] encrypt(int[] dataByte, int[] keyByte) throws Exception {
    ...
    public int[] decrypt(int[] dataByte, int[] keyByte) throws Exception {
        int[][] keys = generateKeys(keyByte);
        int[] ipByte = initPermute(dataByte);
        int[] ipLeft = new int[32];
        int[] ipRight = new int[32];
    ...
    public int[] initPermute(int[] originalData) throws Exception {
    ...
    public int[] expandPermute(int[] rightData) throws Exception {
    ...
    public int[] xor(int[] byteOne, int[] byteTwo) throws Exception {
    ...
    public int[] sBoxPermute(int[] expandByte) throws Exception {
    ...
    public int[] pPermute(int[] sBoxByte) throws Exception {
    ...
    public int[] finallyPermute(int[] endByte) throws Exception {
    ...
    public String getBoxBinary(int i) throws Exception {
        String binary = "";
        switch (i) {
        case 0:
            binary = "0000";
     ...
     * 
     */
    public int[][] generateKeys(int[] keyByte) throws Exception {
        int[] key = new int[56];
